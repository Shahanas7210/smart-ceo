...
const Cook = () => {
  return (
    <section className="relative py-36" id="about-section">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-6">
            ...
            <p className="text-black/60 dark:text-white/60 text-lg mb-6">
              ...
              Management Programe at Premium Resorts and MBA Campuses by
              Utlising 50 plus Segment Expert Brains Especially In Very
              Important 8 Subjects by Leading Faculties
            </p>
            <p className="text-black/60 dark:text-white/60 text-lg mb-6"></p>
            <p className="text-black/60 dark:text-white/60 text-lg"></p>
          </div>
        </div>
      </div>
    </section>
